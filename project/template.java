...
public class template {
    ...
    public static void loadCpuInfo() {
        cpu.read(0);
        // read all the static info - i.e. nujmber cores, model etc.populate it to our
        // data structure
    ...
    public static String getCPUInfo() {
        ...
        sb.append(String.format("Sockets: %d\n", computer.cpu.socketCount));
        sb.append(String.format("Cores per Socket: %d\n", computer.cpu.coresPerSocket));
        sb.append(String.format("L1 Data Cache: %d bytes\n", computer.cpu.l1dCacheSize));
        sb.append(String.format("L1 Instruction Cache: %d bytes\n", computer.cpu.l1iCacheSize));
        sb.append(String.format("L2 Cache: %d bytes\n", computer.cpu.l2CacheSize));
        sb.append(String.format("L3 Cache: %d bytes\n", computer.cpu.l3CacheSize));
